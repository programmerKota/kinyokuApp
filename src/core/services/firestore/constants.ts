export const DISABLE_FIRESTORE =
  process.env.EXPO_PUBLIC_DISABLE_FIRESTORE === "true";
...
const FS_PREFIX =
  rawPrefix && rawPrefix !== "undefined" && rawPrefix !== "null"
    ? rawPrefix
    : "";
const withPrefix = (name: string) =>
  FS_PREFIX ? `${FS_PREFIX}_${name}` : name;
