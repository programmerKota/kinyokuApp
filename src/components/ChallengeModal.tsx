...
const ChallengeModal: React.FC<ChallengeModalProps> = ({
    ...
    const penaltyOptions = [10, 100, 1000, 10000];
                    ...
                    <View style={styles.penaltyOptionsRow}>
                        {penaltyOptions.map((amount) => {
                            ...
                            return (
                                <TouchableOpacity
                                    key={amount}
                                    style={[styles.penaltyChip, selected && styles.penaltyChipSelected]}
                    ...
                    <View style={styles.daysList}>
                        {Array.from({ length: 1000 }, (_, i) => i + 1).map((d) => {
                            ...
                            return (
                                ...
                                >
                                    <Text
                                        style={[styles.dayRowText, selected && styles.dayRowTextSelected]}
                                    >
                                        {d}日
                                    </Text>
                                </TouchableOpacity>
