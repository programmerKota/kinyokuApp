...
const VirtualizedList = <T,>({
    ...
    const renderFooter = useCallback(() => {
        ...
        return (
            <View style={styles.footer}>
                ...
                <Text style={styles.footerText}>{loading ? '読み込み中...' : 'さらに読み込み'}</Text>
            </View>
        );
    ...
    const optimizedGetItemLayout = useMemo<NonNullable<FlatListProps<T>['getItemLayout']>>(() => {
        if (getItemLayout) {
...
const MemoizedVirtualizedList = memo(VirtualizedList) as <T>(props: VirtualizedListProps<T>) => ReactElement;
