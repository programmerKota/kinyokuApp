...
import { View, Text, StyleSheet, Alert, TextInput, TouchableOpacity, Modal as RNModal, TouchableWithoutFeedback, KeyboardAvoidingView, Platform, SafeAreaView, StatusBar } from 'react-native';
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={[uiStyles.rowBetween, styles.footer]}>
                            ...
                            <TouchableOpacity
                                ...
                                style={[styles.postButton, (!content.trim() || !guard.canSend) && styles.postButtonDisabled]}
...
const styles = StyleSheet.create({
    ...
    textInput: {
        ...
        borderRadius: 12,
        padding: spacing.lg,
        paddingLeft: spacing.lg + (getBlockLeftMargin('medium') as any),
        borderWidth: 1,
