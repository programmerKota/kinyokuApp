...
import { SafeAreaView, StatusBar, StyleSheet, View, TextInput, Text, Platform, TouchableOpacity } from 'react-native';
...
const FeedbackScreen: React.FC = () => {
    ...
    const canSend = useMemo(() => subject.trim().length > 0 && message.trim().length > 0, [subject, message]);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <Button title={sent ? '送信しました' : '送信'} onPress={() => { void handleSubmit(); }} disabled={!canSend || sent} loading={sending} />
            </View>
        </SafeAreaView>
    );
};
