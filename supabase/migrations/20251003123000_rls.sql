...
create policy community_posts_insert_auth on public.community_posts for insert to authenticated with check ("authorId" = auth.uid()::text);
create policy community_posts_update_auth on public.community_posts for update to authenticated using ("authorId" = auth.uid()::text) with check ("authorId" = auth.uid()::text);
create policy community_posts_delete_auth on public.community_posts for delete to authenticated using ("authorId" = auth.uid()::text);
...
create policy community_comments_insert_auth on public.community_comments for insert to authenticated with check ("authorId" = auth.uid()::text);
create policy community_comments_update_auth on public.community_comments for update to authenticated using ("authorId" = auth.uid()::text) with check ("authorId" = auth.uid()::text);
create policy community_comments_delete_auth on public.community_comments for delete to authenticated using ("authorId" = auth.uid()::text);
...
create policy community_likes_mutate_auth on public.community_likes for all to authenticated using ("userId" = auth.uid()::text) with check ("userId" = auth.uid()::text);
...
create policy follows_select_self on public.follows for select to authenticated using ("followerId" = auth.uid()::text);
create policy follows_mutate_self on public.follows for all to authenticated using ("followerId" = auth.uid()::text) with check ("followerId" = auth.uid()::text);
...
create policy blocks_select_self on public.blocks for select to authenticated using ("blockerId" = auth.uid()::text);
create policy blocks_mutate_self on public.blocks for all to authenticated using ("blockerId" = auth.uid()::text) with check ("blockerId" = auth.uid()::text);
...
create policy challenges_select_self on public.challenges for select to authenticated using ("userId" = auth.uid()::text);
create policy challenges_mutate_self on public.challenges for all to authenticated using ("userId" = auth.uid()::text) with check ("userId" = auth.uid()::text);

-- diaries (public read, owner write)
...
create policy diaries_mutate_self on public.diaries for all to authenticated using ("userId" = auth.uid()::text) with check ("userId" = auth.uid()::text);
...
create policy tournaments_insert_owner on public.tournaments for insert to authenticated with check ("ownerId" = auth.uid()::text);
create policy tournaments_update_owner on public.tournaments for update to authenticated using ("ownerId" = auth.uid()::text) with check ("ownerId" = auth.uid()::text);
...
create policy participants_insert_self on public.tournament_participants for insert to authenticated with check ("userId" = auth.uid()::text);
...
create policy join_requests_select_self_or_owner on public.tournament_join_requests for select using (
  "userId" = auth.uid()::text or exists (
    select 1 from public.tournaments t where t.id = "tournamentId" and t."ownerId" = auth.uid()::text
  )
);
create policy join_requests_insert_self on public.tournament_join_requests for insert to authenticated with check ("userId" = auth.uid()::text);
create policy join_requests_owner_update on public.tournament_join_requests for update to authenticated using (
  exists (select 1 from public.tournaments t where t.id = "tournamentId" and t."ownerId" = auth.uid()::text)
) with check (true);
...
create policy tournament_messages_insert_auth on public.tournament_messages for insert to authenticated with check ("authorId" = auth.uid()::text);
